...
# **Exercice 1. ** -----
# Pour cet exercice vous allez réaliser une classification sur base de l'ACP réalisée pour le TP9. Il s'agissait d'un ACP sur une série de variables (ACP_BXL.xls) choisies a priori pour résumer la division en quadrant et centre-périphérie de Bruxelles. Trois variables (PSOC123,PSOC456 ,PSOC78910) sont redondante avec DEC_SOCX, retirez les du set de données. Retirez également de l'analyse les secteurs statistiques où la population est égale à 0.
...
# NBCAR_MEN nombre de voitures par ménages
...
# **Exercice 1.1. ** -----
# ACP:
# Comme pour le TP 9, réalisez une ACP en pondérant chaque secteur statistique par le nombre d'habitant-es en 2018 et retenez les 2 première composantes:
# eigenvalue percentage of variance cumulative percentage of variance
# comp 1  16.59           36.8                          36.86989
# comp 2  7.21            16.0                          52.91117
# comp 3  3.530            7.9                          60.7717
...
# **Exercice 1.2. ** -----
# Classification
# Réalisez une classification ascendante hiérarchique sur les deux premières composantes en utilisant des distances euclidienne et la méthode de Ward. Exporter un dendogramme et un graphique des gains d'inertie.



# **Exercice 1.3. ** -----
# Joignez vos résultats les scores de votre ACP et les groupes de votre classification à votre set de données et réalisez:
# - un graphique qui reprend les score de chaque secteurs statistiques sur les deux premières composantes et leur groupe
# - une carte des secteurs statistiques où la taille est proportionnelle au nombre d'habitants et la couleur correspondante au groupe de votre classification
...
# **Exercice 1.4. ** -----
# Comptez le nombre d'habitants et le nombre de voitures pour chaque groupe (en milliers) et ratio nombre de voitures divisé par la population

#  clust   pop voitures voit_pop
#  <fct> <dbl>    <dbl>    <dbl>
# 1      335.     64.4     19.2
# 2      372.    106.      28.4
# 3      244.     96.6     39.5
